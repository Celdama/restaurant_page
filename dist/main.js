...
const displayNavBarDown = () => {
  ...
  const firstLink = (0,_elementFactory__WEBPACK_IMPORTED_MODULE_0__["default"])('a', '', 'down-left');
  const instagramIcon = (0,_elementFactory__WEBPACK_IMPORTED_MODULE_0__["default"])('i', '', 'social-icon');
  const facebookIcon = (0,_elementFactory__WEBPACK_IMPORTED_MODULE_0__["default"])('i', '', 'social-icon');
  const mapIcon = (0,_elementFactory__WEBPACK_IMPORTED_MODULE_0__["default"])('i', '', 'social-icon');
  ...
  (0,_appendElementToParent__WEBPACK_IMPORTED_MODULE_1__["default"])(firstLink.el, instagramIcon, facebookIcon, mapIcon);
